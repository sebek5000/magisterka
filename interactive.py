...
btn4 = Button(root, text='następny', command=next).pack(side = RIGHT)
btn5 = Button(root, text='powiększ', command=enlarge).pack(side = RIGHT)
btn6 = Button(root, text='pomniejsz', command=reduce).pack(side = RIGHT)
btn7 = Button(root, text='dodaj', command=add).pack(side = RIGHT)
btn8 = Button(root, text='usuń', command=delete).pack(side = RIGHT)
panel.pack()
